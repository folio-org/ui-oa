    ...
    return (
      <div>
        {fields.map((streetAddress, index) => (
          <EditCard
            key={streetAddress}
            deleteButtonTooltipText={<FormattedMessage id="ui-oa.streetAddresses.removeStreetAddress" values={{ number: index + 1 }} />}
            header={<FormattedMessage id="ui-oa.streetAddresses.streetAddressTitle" values={{ number: index + 1 }} />}
          ...
          >
            <Row>
              <Col xs={3}>
                <Field
                  component={TextField}
                  label={<FormattedMessage id="ui-oa.streetAddresses.addressType" />}
              ...
              <Col xs={3}>
                <Field
                  component={TextField}
                  label={<FormattedMessage id="ui-oa.streetAddresses.addressLine1" />}
              ...
              <Col xs={3}>
                <Field
                  component={TextField}
                  label={<FormattedMessage id="ui-oa.streetAddresses.addressLine2" />}
            ...
            <Row>
              <Col xs={3}>
                <Field
                  component={TextField}
                  label={<FormattedMessage id="ui-oa.streetAddresses.stateRegion" />}
              ...
              <Col xs={3}>
                <Field
                  component={TextField}
                  label={<FormattedMessage id="ui-oa.streetAddresses.postalCode" />}
